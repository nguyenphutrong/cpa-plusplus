...
//
// Supported channels: gemini-cli, vertex, aistudio, antigravity, claude, codex, kimi, github-copilot, kiro.
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		...
		return "codex"
	case "gemini-cli", "aistudio", "antigravity", "kimi", "github-copilot", "kiro":
		return provider
	default:
		return ""
	}
