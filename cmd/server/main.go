...
func main() {
	fmt.Printf("cpa-plusplus Version: %s, Commit: %s, BuiltAt: %s\n", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
	...
	if strings.TrimSpace(homeJWT) != "" {
		...
		parsed.Home = homeCfg
		parsed.Port = 8386 // Default to 8386 for home mode, can be overridden by home config
	...
	log.Infof("cpa-plusplus Version: %s, Commit: %s, BuiltAt: %s", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
